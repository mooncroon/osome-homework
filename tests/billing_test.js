...
const phoneNumber = '93-12-351-235';
const code = '1235';
const subscriptionName = 'Bonanza — Yearly';
const dueOnDate = 'Due on 27 Mar 2022';

Before(({
  I, loginPage, navigationBar, billingPage,
}) => {
...
// Scenario('Control user cards', async ({ I, billingPage }) => {
